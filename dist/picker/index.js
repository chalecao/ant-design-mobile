...
var treeFilter = _interopDefault(require('array-tree-filter'));
var React = _interopDefault(require('react'));
var RMCCascader = _interopDefault(require('rmc-cascader/lib/Cascader'));
var RMCPopupCascader = _interopDefault(require('rmc-cascader/lib/Popup'));
var RMCMultiPicker = _interopDefault(require('rmc-picker/lib/MultiPicker'));
var RMCPicker = _interopDefault(require('rmc-picker/lib/Picker'));
...
var Picker = function (_AbstractPicker) {
    inherits(Picker, _AbstractPicker);

    function Picker() {
        classCallCheck(this, Picker);

        var _this = possibleConstructorReturn(this, _AbstractPicker.apply(this, arguments));
