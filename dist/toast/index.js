...
var _componentIndexof_0_0_3_componentIndexof = function _componentIndexof_0_0_3_componentIndexof(arr, obj) {
...
try {
  ...
  var index = _componentIndexof_0_0_3_componentIndexof;
}
...
var _componentClasses_1_2_6_componentClasses = function _componentClasses_1_2_6_componentClasses(el) {
...
var lib = createCommonjsModule(function (module, exports) {
  ...
  var _componentClasses2 = _interopRequireDefault(_componentClasses_1_2_6_componentClasses);
...
unwrapExports(lib);
var lib_1 = lib.isCssAnimationSupported;
...
var AnimateChild_1 = createCommonjsModule(function (module, exports) {
  ...
  var _propTypes2 = _interopRequireDefault(_propTypes_15_6_2_propTypes);

  var _cssAnimation2 = _interopRequireDefault(lib);
...
var Animate_1 = createCommonjsModule(function (module, exports) {
  ...
  var Animate = function (_React$Component) {
    ...
    function Animate(props) {
      ...
      _this.state = {
        children: (0, ChildrenUtils.toArrayChildren)(getChildrenFromProps(props))
      };
  ...
  var _initialiseProps = function _initialiseProps() {
    ...
    this.handleDoneLeaving = function (key) {
      ...
      if (_this5.isValidChildByKey(currentChildren, key)) {
        ...
        if (!(0, ChildrenUtils.isSameChildren)(_this5.state.children, currentChildren, props.showProp)) {
          _this5.setState({
...
var Notification_1 = createCommonjsModule(function (module, exports) {
  ...
  var _rcAnimate2 = _interopRequireDefault(Animate_1);
...
var Notification$1 = unwrapExports(lib$1);
...
var Icon = function (_React$Component) {
    inherits$2(Icon, _React$Component);

    function Icon() {
        classCallCheck$2(this, Icon);
    ...
    Icon.prototype.render = function render() {
        ...
        return React.createElement(
            'svg',
            _extends$2({ className: cls }, restProps),
...
function getMessageInstance(mask, callback) {
    ...
    Notification$1.newInstance({
        ...
        className: classnames((_classnames = {}, _classnames[prefixCls + '-mask'] = mask, _classnames[prefixCls + '-nomask'] = !mask, _classnames))
    }, function (notification) {
